...
enum class ueCameraProjection { Orthographic, Perspective };

struct ueCameraSimpleFPVController
{
...
struct ueCamera {
    ...
    explicit ueCamera() = default;

    explicit ueCamera(ueCameraProjection projection);
    ...
    [[nodiscard]] ueCameraProjection getProjectionType() const;

private:
    ueCameraProjection _projectionType;
